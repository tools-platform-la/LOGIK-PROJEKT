...
cleanup() {
    [[ -f "./decrypted_ssh_keys_2025_11_01-10_17_41.tar" ]] && shred -u -f -z "./decrypted_ssh_keys_2025_11_01-10_17_41.tar" \
        2>/dev/null || true
}
trap cleanup EXIT
...
if openssl enc -d -aes-256-cbc \
    -pbkdf2 -iter 100000 \
    -in "./encrypted_ssh_keys_2025_11_01-10_17_41.tar.enc" \
    -out "./decrypted_ssh_keys_2025_11_01-10_17_41.tar" \
